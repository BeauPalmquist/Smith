...
(function ($) {
	...
	$.maskElement = function (element, label) {
		...
		if (label !== undefined) {
			...
			maskMsgDiv.append('<div class="clearfix"><div class="w-loader"></div><span class="w-mask-label">' + label + '<span></div>');
